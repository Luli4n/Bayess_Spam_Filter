...
class TrainingSet(WordSet.WordSet):
    ...
    def split(self):
        ...
        self.unique_setS = set(self.unique_setS)
        self.unique_setS = list(self.unique_setS)
        self.unique_setH = set(self.unique_setH)
        self.unique_setH = list(self.unique_setH)
